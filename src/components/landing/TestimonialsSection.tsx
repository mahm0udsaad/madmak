...
const testimonials = [
  {
    name: 'أحمد الغامدي',
    role: 'صاحب شركة',
    content: 'تعاملت مع مدماك لتركيب نظام مراقبة كامل في شركتي. الخدمة ممتازة والتركيب احترافي. أنصح الجميع بالتعامل معهم.',
    rating: 5,
  },
  {
    name: 'محمد العتيبي',
    role: 'صاحب منزل',
    content: 'ركبت كاميرات واي فاي في منزلي من مدماك. الجودة عالية والتطبيق سهل الاستخدام. شكراً لفريق العمل المتميز.',
    rating: 5,
  },
  {
    name: 'خالد الشمري',
  ...
  },
  {
    name: 'فهد القحطاني',
    role: 'صاحب محل تجاري',
    content: 'ركبت نظام إنتركم ذكي من مدماك. التركيب تم في نفس اليوم والجودة تفوق التوقعات. شكراً مدماك.',
    rating: 5,
  },
];
